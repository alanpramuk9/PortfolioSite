$(document).ready(function() {
	...
	$('.downloader').tooltip({
		title: "<p class='downloadTooltip'> Download my Resume <p>",
		html: true,
		placement: 'top',
		animation: true,
	});
	$('.github').tooltip({
		title: "<p class='downloadTooltip'> View all my project's code <p>",
		html: true,
		placement: 'top',
		animation: true,
	});
	$('.email').tooltip({
		title: "<p class='downloadTooltip'> alanpramuk9@gmail.com <p>",
		html: true,
		placement: 'top',
		animation: true,
	});
	$('.linkedin').tooltip({
		title: "<p class='downloadTooltip'> Go to my LinkedIn <p>",
		html: true,
		placement: 'top',
		animation: true,
	});
